      ...
      <section className="relative overflow-hidden bg-jr-green-dark border-b border-jr-line">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 py-32 lg:py-48">
          ...
          <div className="max-w-2xl text-white">
            <p className="text-xs font-bold uppercase tracking-[0.2em] text-emerald-300 mb-3">{eyebrow}</p>
            <h1 className="font-display text-4xl font-bold leading-tight lg:text-5xl drop-shadow-sm">
              {title}
            </h1>
            <p className="mt-5 text-lg leading-relaxed text-white/80 drop-shadow-sm max-w-xl">{description}</p>
          </div>
        </div>
      </section>
    );
